...
var RetoricaStorage = {
    ...
    save: function() {
        if (!window.retoricaActiveUser) { 
            RetoricaUI.notify("Inicia sesión para guardar tus proyectos."); 
            return; 
        }
        ...
        this.refreshLibrary();
        RetoricaUI.notify("Proyecto guardado localmente ✓");
    },
    ...
    exportToHTML: function() {
        ...
        link.click();
        RetoricaUI.notify("Archivo HTML guardado y descargado ✓");
    },
    ...
    refreshLibrary: function() {
        ...
        for (var i = 0; i < projectList.length; i++) {
            ...
            // Filtrar y aislar estrictamente por el usuario activo logueado
